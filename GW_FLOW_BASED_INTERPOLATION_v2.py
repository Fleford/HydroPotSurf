...
def calculate_new_k_field_cosine_plane(h_matrix, k_matrix, obs_matrix, scale_factor):
    ...
    # scale_factor = -1
    perturbation_array = 2**(generate_cosine_array(k_matrix, 1, 2) * scale_factor)
    ...
    for obs_cood in obs_indexes:
        # Calculate head error
        new_head_error = new_h_matrix[obs_cood[0], obs_cood[1]] - obs_matrix[obs_cood[0], obs_cood[1]]
        # Update total error
        new_total_head_error += abs(new_head_error)
        # Calculate error array
        new_error_array.append(new_head_error)
...
if __name__ == "__main__":
    ...
    k_field2_new = calculate_new_k_field_cosine_plane(h_field, k_field, obs_field, 1)
    k_field2_new = calculate_new_k_field_cosine_plane(h_field, k_field, obs_field, 0.5)
    k_field2_new = calculate_new_k_field_cosine_plane(h_field, k_field, obs_field, 0.25)
    k_field2_new = calculate_new_k_field_cosine_plane(h_field, k_field, obs_field, 0.125)
    k_field2_new = calculate_new_k_field_cosine_plane(h_field, k_field, obs_field, 0.0625)
    k_field2_new = calculate_new_k_field_cosine_plane(h_field, k_field, obs_field, 0)
    k_field2_new = calculate_new_k_field_cosine_plane(h_field, k_field, obs_field, -0.0625)
    k_field2_new = calculate_new_k_field_cosine_plane(h_field, k_field, obs_field, -0.125)
    k_field2_new = calculate_new_k_field_cosine_plane(h_field, k_field, obs_field, -0.25)
    k_field2_new = calculate_new_k_field_cosine_plane(h_field, k_field, obs_field, -0.5)
